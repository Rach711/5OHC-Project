...
if [ $# -lt 1 ]; then
  ...
  echo "Usage: ./curves.sh <sequence_name>" >&2
  echo "Example: ./curves.sh APC_4103_non" >&2
  exit 1
fi
...
# ==============================================================================
# MAIN CURVES+ LOOP (Runs only the 3 replicates for the selected sequence)
# ==============================================================================
...
echo "=================================================="
echo " ALL 3 REPLICATES FOR $SEQ COMPLETED SUCCESSFULLY "
echo "=================================================="